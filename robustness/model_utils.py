...
def make_and_restore_model(*_, arch, dataset, resume_path=None,
         parallel=False, pytorch_pretrained=False, add_custom_forward=False,cuda=True, args = None):
    """
    ...
    classifier_model = dataset.get_model(arch, pytorch_pretrained,args) if \
    ...
    if resume_path and os.path.isfile(resume_path):
        ...
        checkpoint = ch.load(resume_path, pickle_module=dill,map_location='cpu' if not cuda else None)
